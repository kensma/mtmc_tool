...
class IdentityMTMC(_BaseMetric):
    ...
    def eval_sequence(self, data):
        ...
        for cam in data['cams']:
            for t, (gt_ids_t, tracker_ids_t) in enumerate(zip(data['gt_ids'][cam], data['tracker_ids'][cam])):
                # Count the potential matches between ids in each timestep
                matches_mask = np.greater_equal(data['similarity_scores'][cam][t], self.threshold)
